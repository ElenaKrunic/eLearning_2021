	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity
			...
			.sessionManagement()
				...
				.and()
			.authorizeRequests()
				.antMatchers( "/","/api/login","/styles.css","/runtime.js","/polyfills.js","/vendor.js","/main.js","/favicon.ico","/styles.css.map","/runtime.js.map","/polyfills.js.map","/vendor.js.map","/main.js.map").permitAll() 
