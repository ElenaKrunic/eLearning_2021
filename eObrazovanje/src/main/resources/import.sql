...
INSERT INTO student (id, account_number,card_amount,card_number,email,first_name,last_name,model_number,phone_number,reference_number,started_college_in,umnc,type_of_financing) VALUES
 (1, '1236548-896-6',800.00,'125-698-365','pera@gmail.com','Pera','Simic',97,'065-489-986','1254-78-965-65',2015,'145879652345',1);
...
--
--INSERT INTO exam_period (id, end_date,name,payment_amount,start_date,exam) VALUES (1, '10-02','january',200.0,'10-01',1);
--INSERT INTO exam_period (id, end_date,name,payment_amount,start_date,exam) VALUES (2, '20-02','february',200.0,'11-02',2);
--INSERT INTO exam_period (id, end_date,name,payment_amount,start_date,exam) VALUES (3, '10-04','april',200.0,'05-04',1);
--INSERT INTO exam_period (id, end_date,name,payment_amount,start_date,exam) VALUES (4, '10-07','june',200.0,'10-06',1);
--INSERT INTO exam_period (id, end_date,name,payment_amount,start_date,exam) VALUES (5, '20-07','july',200.0,'11-07',2);
--INSERT INTO exam_period (id, end_date,name,payment_amount,start_date,exam) VALUES (6, '20-09','september',200.0,'10-09',1);
--INSERT INTO exam_period (id, end_date,name,payment_amount,start_date,exam) VALUES (7, '20-10','october',200.0,'11-10',2);
--
